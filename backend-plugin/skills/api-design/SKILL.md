...
- **주요 기술**: JPA/Hibernate 7, QueryDSL, JWT, Kafka, RestClient
- **API 문서**: SpringDoc OpenAPI (Swagger UI)
- **JSON**: Jackson 3 (`JsonMapper`, `tools.jackson` 패키지)
- **HTTP Client**: `RestClient` (RestTemplate 대신 사용)
...
- `@NoArgsConstructor(access = AccessLevel.PROTECTED)` (Jackson 3 역직렬화용)
